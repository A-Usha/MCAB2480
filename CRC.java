...
public class CRC {
    ...
    // Method to repeat a character 'n' times (custom implementation for versions earlier than Java 11)
    ...
    public boolean Check_CRC(String data, String polynomial) {
        ...
        return remainder.equals(repeatChar('0', polynomial.length() - 1)); // Valid if remainder is all zeros
    }
