...
class DoublyLinkOp {
    ...
    public void insertF(int x) {
        Node temp = new Node();
        if (temp == null) {
            System.out.println("Memory allocation failed for insertion.");
            return;
        } 
        temp.data = x;
        temp.next = header;
    ...
    public DoublyLinkOp merge(DoublyLinkOp otherList) {
        DoublyLinkOp mergedList = new DoublyLinkOp();
    ...
    public static void main(String[] args) {
        ...
        DoublyLinkOp list1 = new DoublyLinkOp();
        DoublyLinkOp list2 = new DoublyLinkOp();
            ...
            while (true) {
                ...
                switch (choice) {
                    ...
                    case 9:
                        ...
                        DoublyLinkOp mergedList = list1.merge(list2);
                        mergedList.print();
                        break;
